...
namespace PhpTaxonomy\MultiTaxonomy\DbalUtilBundle\Controller;
...
class DefaultController extends Controller
{
    ...
    public function newAction(Request $request, UserInterface $user)
    {
        ...
        $form = $this->createForm(TaxonomyForm::class);
    ...
    // public function editAction(Request $request, URL $uRL)
    {
        ...
        $editForm = $this->createForm(TaxonomyForm::class, $taxonomyTree);
